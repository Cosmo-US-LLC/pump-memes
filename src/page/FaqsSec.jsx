...
const FaqItem = ({ question,
  ...
  return (
    <div className={`border-b-[1.2px] border-solid ${isOpen?"border-[#fff]":"border-[#fff]"}  border-solid`}>
      <div
        className="flex justify-between items-center pt-[16px] xs:pt-[10px] xs:pb-[10] pb-[16px] gap-[25px] cursor-pointer"
        onClick={handleClick}
      >
        <div
          className={`pt-[24px] xs:pt-[14px]  text-[24px] text-[#fff] font-[900]`}
        >
           {question}
        </div>
...
const FaqSec = () => {
  const faqData = [
    {
        ...
        answer:"Pump Memes is a community-driven Crypto Launchpad where you can easily launch and trade meme coins with unique features and enhanced functionalities.",
      },
      {
  ...
  return (
    <>
      <div className="bg-[#002D84] relative" >
        <div className=" w-[100%] max-w-[1155px] pt-[73px] mx-auto pb-[85px]">
         ...
         <p className="text-[28px] font-[400] text-[#FFF] text-center">Check out our answers to the most common community questions</p>
         <img src={faqvet1} className="absolute left-[3%] top-[-6%]" alt="" />
         <img src={faqvet2} className="absolute right-[3%] top-[-6%]" alt="" />
          </div>
