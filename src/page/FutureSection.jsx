...
function FutureSection() {
    ...
    return (
        <div className="h-[903px] bg-[#FF5400] py-24 flex flex-col gap-8">
            <div className="flex flex-row justify-around items-center">
                <div>
                    <h2 className="text-[55px] font-[700] leading-[66px] text-[white]">The Future Of Memes</h2>
                    <p className="max-w-[744px] text-[28px] font-[400] leading-[33px] text-[white]">Our roadmap is focused on fast growth and mass adoption, delivering the best, safest, and most fun way to launch and trade meme coins.</p>
                </div>
            ...
            <div className="flex flex-row items-center justify-center gap-10">
                <div className="h-[443px] bg-[#FCC105] w-[484px] border border-[4px] border-[black] p-12">
                    ...
                    <p className="text-[32px] font-[600] leading-[29px] ml-4">Idea and Concept</p>
                ...
                <div className="h-[443px] bg-[white] w-[484px] border border-[4px] border-[black] p-12">
                    ...
                    <p className="text-[32px] font-[600] leading-[29px] ml-4">Building</p>
                    <div className="flex flex-col gap-2 mt-10">
                        {
                ...
                <div className="h-[443px] bg-[white] w-[484px] border border-[4px] border-[black] p-12">
                    ...
                    <p className="text-[32px] font-[600] leading-[29px] ml-4">Launch</p>
