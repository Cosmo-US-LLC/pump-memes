      ...
      <div className="bgnonebox">
        <div className="  pt-[50px] pb-[30px]">
          <div className="pb-[45px]">
            <p
              className="font-[Tomorrow] text-[58px] font-[700] text-[#FFF] text-center"
              style={{
          ...
          <div className="w-[100%] max-w-[1241px] w-[100%] mx-auto flex justify-between">
            <div className="w-[50%] space-y-[35px] ">
              <h3 className="max-w-[427px] w-[100%] leading-[120%] font-[Tomorrow] text-[55px] font-[700] text-center">
            ...
            <div className="w-[50%] space-y-[35px] ">
              <h3 className="max-w-[380px] w-[100%] mx-auto leading-[120%] font-[Tomorrow] text-[55px] font-[700] text-center">
                ..And None Of this
              </h3>
