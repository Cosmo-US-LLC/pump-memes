...
import Pumpnomvect6 from "../assets/Svgs/pump-othwe.svg";
...
function PumpnomicsSec() {
  return (
    <div
      id="tokenomics"
      className="w-[100%] pt-[68px] relative  w-[100%] mx-auto bg-[#F6C929]"
    >
      <div className="max-w-[910.934px] pb-[90px] space-y-[30px] w-[100%] mx-auto ">
        <h4 className="font-[Tomorrow] text-[55px] font-[700] leading-normal text-center text-[#000]">
          Pumpnomics
        </h4>
      ...
      <div className="bg-[#AFCD3A]  border-[3px] border-[#000]">
        <div className="max-w-[950px] py-[40px] flex justify-between items-center w-[100%] mx-auto">
          <div className="flex items-center space-x-3">
            <div
              className="bg-[#FFF] border border-black w-[105px] h-[86px] flex justify-center items-center"
              style={{
            ...
            <div className="space-y-[-3px]">
              <h3 className="font-[Tomorrow] bessttroksmp text-[#A387FF] text-[55px] font-[700]">
                Sol
              </h3>
              <p className="text-[#000] text-[20px] font-[700] uppercase">
                Solana Token
              </p>
            </div>
          </div>
          <div className="flex items-center space-x-3">
            ...
            <div className="space-y-[-3px]">
              <h3 className="font-[Tomorrow] bessttroksmp text-[#FF8000] text-[55px] font-[700]">
                2.5B
              </h3>
              <p className="text-[#000] text-[20px] font-[700] uppercase">
                Total Supply
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="space-y-[-3px]">
              <h3 className="font-[Tomorrow] bessttroksmp text-[#FDBE31] text-[55px] font-[700]">
                PUMP
              </h3>
              <p className="text-[#000] text-[20px] font-[700] uppercase">
                TICKER
