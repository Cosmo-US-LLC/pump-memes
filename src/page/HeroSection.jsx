      ...
      <div className="max-w-[1296px] 2xl:relative xl:unset lg:unset md:unset sm:unset unset w-[100%] flex justify-between mx-auto pt-[209px]">
        ...
        <div className="max-w-[695px] relative w-[100%] pt-[87px]">
          ...
          <p className="max-w-[641px] w-[100%] text-[20px] font-[400] text-[#000] py-[20px]">
            Pump Memes is a launchpad where users earn, not just the developers.
            It’s secure, fair, and built for the community. $PUMP holders get
            rewards in SOL from every coin launched on Pump Memes, all while
          ...
          <div className="flex space-x-[18px] max-w-[425px] w-[100%] py-[20px] px-[17px] bg-[#7D67BF] shadow-3xl">
            ...
            <div className="px-[10px] py-[8px] shadow-3xl flex flex-col items-center bg-[#FFD92F] border border-[#000]">
              ...
              <h3 className="text-[21.622px] font-[900] text-[#000]">PNUT</h3>
        ...
        <div className="max-w-[483.742px] w-[100%] min-h-[665px] herowalletbg px-[35px] pb-[35px] pt-[45px] space-y-[20px]">
          ...
          <div className="">
            ...
            <div className="h-[56px] flex items-center justify-between border-[1.832px] border-[#50505040] p-[5px]">
              <div className="relative inline-block">
                ...
                {isOpen && (
                  <div className="absolute top-full w-[max-content] mt-2 bg-[#2d2d2d] shadow-md z-10 max-h-[250px] overflow-y-auto">
              ...
              <div className="space-x-1">
                <input
                  type="text"
                  className="placeholder-[#fff] text-[#fff] text-end h-[45.809px] bg-[#000] outline-none m-0"
          ...
          <div className="flex space-x-3 ites-center">
            <div>
              <input
                type="checkbox"
                name=""
                className="inputwellat h-[36.647px] w-[36.647px] border bg-black border-[#FFCE00] "
                id=""
          ...
          <div>
            <div className="flex gap-4">
              <button
                className="text-[16.491px] font-[700] text-[#000] bg-[#FFCE00] h-[45.809px] border-[1.214px ] border-[#000] w-[100%] hover:bg-[#000] hover:text-[#fff] hover:border hover:border-[#FFCE00]"
                onClick={() => {
              ...
              {accountData.isConnected && (
                <button
                  className="text-[16.491px] font-[700] text-[#000] bg-[#FFCE00] h-[45.809px] border-[1.214px ] border-[#000] w-[100%] hover:bg-[#000] hover:text-[#fff] hover:border hover:border-[#FFCE00] leading-[1]"
                  onClick={async () => {
                    const { config } = await getConfig()
                    disconnect(config)
                  }}
                >
                  Disconnect ({truncateString(accountData.address, 15)})
                </button>
              )}
            </div>
            <a
